...
// Discord invite URL for the Hardware Club server
const HARDWARE_CLUB_DISCORD_URL = "https://discord.gg/YOUR_PERMANENT_INVITE";
...
const HomePage = ({
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden">
      ...
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:fixed focus:top-2 focus:left-2 focus:z-[999] focus:rounded-lg focus:bg-ieee-600 focus:px-4 focus:py-2 focus:text-sm focus:font-semibold focus:text-white focus:shadow-lg"
      >
        Skip to content
      </a>
        ...
        >
          ...
          <div className="relative z-10 mx-auto max-w-4xl px-4 md:px-6 text-center">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                 <a
                   href={HARDWARE_CLUB_DISCORD_URL}
                   target="_blank"
      ...
      <footer id="contact" className="border-t border-slate-200 bg-white py-10 text-slate-700 md:py-12">
        <div className="mx-auto max-w-6xl px-4 md:px-6">
          ...
          <p className="mt-4 text-sm text-slate-600">Follow us:</p>
