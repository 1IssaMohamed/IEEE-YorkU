    ...
    <article className={`flex flex-col items-center rounded-xl border-2 bg-white text-slate-900 border-ieee-500 p-4 md:p-6 shadow-md transition hover:shadow-lg ${!hasData ? 'opacity-60' : ''}`}>
      ...
      {hasData && hasLinkedin && (
        <a 
          ...
          className="mt-3 inline-flex h-11 w-11 items-center justify-center rounded-full bg-blue-600 text-white transition-transform hover:-translate-y-1 hover:bg-blue-700"
